...
void test_test(void) {
  ...
  layer allies = {0,0};
  layer allies_r = {0,0};
  read_layer(l_input, 'O', allies);
  rotate_layer(allies, allies_r);
...
void test_capture(void (*func)(layer, layer, layer, layer, const unsigned char),
  ...
  layer allies = {0,0};
  layer allies_r = {0,0};
  read_layer(input_string, 'O', allies);
  rotate_layer(allies, allies_r);
